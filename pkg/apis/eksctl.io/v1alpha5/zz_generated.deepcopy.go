...
func (in *ClusterSubnets) DeepCopyInto(out *ClusterSubnets) {
	*out = *in
	if in.Private != nil {
		...
		*out = make(ZoneSubnetMapping, len(*in))
		for key, val := range *in {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ZoneSubnetMapping) DeepCopyInto(out *ZoneSubnetMapping) {
	{
		in := &in
		*out = make(ZoneSubnetMapping, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ZoneSubnetMapping.
func (in ZoneSubnetMapping) DeepCopy() ZoneSubnetMapping {
	if in == nil {
		return nil
	}
	out := new(ZoneSubnetMapping)
	in.DeepCopyInto(out)
	return *out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ZoneSubnetSpec) DeepCopyInto(out *ZoneSubnetSpec) {
	*out = *in
	if in.CIDR != nil {
		in, out := &in.CIDR, &out.CIDR
		*out = (*in).DeepCopy()
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ZoneSubnetSpec.
func (in *ZoneSubnetSpec) DeepCopy() *ZoneSubnetSpec {
	if in == nil {
		return nil
	}
	out := new(ZoneSubnetSpec)
	in.DeepCopyInto(out)
	return out
}
